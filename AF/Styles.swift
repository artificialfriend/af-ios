...
extension Font {
    ...
    static let sixtyfour: Font = Font.custom("AvenirNext-Bold", size: 64)
    static let sixteen: Font = Font.custom("AvenirNext-Medium", size: 16)
    static let sixteenBold: Font = Font.custom("AvenirNext-Bold", size: 16)
...
extension Animation {
    ...
    static let shortSpringC: Animation = Animation.spring(response: 0.4, dampingFraction: 0.6, blendDuration: 0.1)
    static let shortSpringD: Animation = Animation.spring(response: 0.15, dampingFraction: 1, blendDuration: 0.1)
    static let shortSpringE: Animation = Animation.spring(response: 0.2, dampingFraction: 0.7, blendDuration: 0.1)
