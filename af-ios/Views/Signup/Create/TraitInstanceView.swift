...
struct TraitInstanceView: View {
    ...
    var body: some View {
        ZStack {
            //setTraitInstanceViewElements().0
        ...
        .background(setTraitInstanceViewElements().1)
        .cornerRadius(cr16)
        .overlay(
            RoundedRectangle(cornerRadius: cr16)
                .stroke(activeInstance.name == instance.name ? af.af.interface.userColor : setTraitInstanceViewElements().2, lineWidth: activeInstance.name == instance.name ? 2.5 : 2)
    ...
    func setTraitInstanceViewElements() -> (Image, Color, Color) {
    ...
    func setTraitInstanceImg(instance: any TraitInstance) -> TraitInstanceImage {
        if instance.trait == .skinColor {
