...
extension Animation {
    ...
    static let shortSpringA: Animation = Animation.spring(response: 0.2, dampingFraction: 1, blendDuration: 0.1)
    static let shortSpringB: Animation = Animation.spring(response: 0.2, dampingFraction: 1, blendDuration: 0.1)
    static let shortSpringC: Animation = Animation.spring(response: 0.2, dampingFraction: 0.8, blendDuration: 0.1)
    ...
    static let shortSpringG: Animation = Animation.spring(response: 0.15, dampingFraction: 1, blendDuration: 0.1)
    ...
    static let linear0_5: Animation = Animation.linear(duration: 0.05)
    ...
    static let loadingSpin: Animation = Animation.linear(duration: 1).repeatForever(autoreverses: false)
